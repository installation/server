...
install() {
	...
	sudo -u $user -H wget http://redminecrm.com/license_manager/4478/redmine_contacts_invoices-2_1_0-light.zip
	sudo -u $user -H unzip redmine_contacts_invoices-2_1_0-light.zip
	...
	sudo rm -rf redmine_contacts_invoices-2_1_0-light.zip
